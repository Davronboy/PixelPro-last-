...
let data = [{
        ...
        paragraph: "Pixel has replaced the whiteboard for us! Being able to jump in the same file with someone fills the gap of not being able to gather in person.",
        link: "Read Story",
    },
    {
